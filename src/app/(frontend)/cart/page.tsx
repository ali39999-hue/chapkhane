...
export default function CartPage() {
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col justify-between pt-28 pb-20 relative font-sans overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-4xl flex-1 flex items-center justify-center relative z-10">
        <div className="bg-white rounded-2xl border border-secondary-200 shadow-soft p-12 text-center flex flex-col items-center justify-center min-h-[400px] w-full">
          ...
          <h2 className="text-2xl font-black text-secondary-900 mb-3">سبد خرید شما در حال حاضر خالی است.</h2>
