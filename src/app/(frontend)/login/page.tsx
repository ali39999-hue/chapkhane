...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="min-h-screen bg-secondary-50 text-foreground flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden font-sans" dir="rtl">
      {/* Background decor */}
      ...
      <Link href="/" className="mb-8 flex items-center gap-3 group">
        ...
        <div>
          ...
          <span className="text-[10px] text-primary-600 font-bold block flex items-center gap-1">
            <Cpu size={10} />
      ...
      <div className="w-full max-w-md flex flex-col items-center gap-3 mb-6">
        <span className="inline-flex items-center gap-2 text-[11px] font-bold text-primary-700 bg-primary-50 border border-primary-100 px-4 py-1.5 rounded-full shadow-sm">
          <Cpu size={12} />
          ورود به حساب کاربری چاپخانه نگار
        </span>
      </div>
